...
C'est alors que l'accès à la **Salle des Etincelles** sera permis. Snow avertira le Joueur quant à cette salle, mais admettra qu'il lui sera nécessaire d'y passer s'il veut passer la _Salle des Tentations_.
...
- Ce sera un mob fort en terme d'attaque. Pour le vaincre, il y'aura deux moyens :
  ...
  - Lui parler avec Snow, de sorte à comprendre son être.
    ...
    - On apprend qu'il a été envahi par le doute. Son but était de venger sa femme louve qui s'est faite brûler dans un incendie commis par Zrog. En restant dans cette salle à la **recherche de la solution**, il n'a pas pu la trouver et a fini par se faire _envahir par la haine_. Jusqu'à atteindre cet état.
...
## Chapitre 2 - L'étage de la Sorcière (Soleil)
...
Elle se moquera un peu de lui, et lui dira qu'elle connaît bien son chemin.
Mais deux énormes Scarabées débarquent, et un nouveau combat débute, avec Choco dans l'équipe.
D'ailleurs, le Joueur combattra avec Choco en premier exceptionnellement, pour tester ses capacités s'il le souhaite.
Le combat est assez classique, et sert de tuto pour s'entraîner à manipuler Choco.
Une fois terminée, Choco est soulagée et montre au Héros que la Porte est juste en face de lui.
"Il n'y a rien en face ? Tu es sûr ? Regarde : ", et une porte s'ouvre de nulle part.
"C'est une illusion ici, a chaque fois que tu fais un pas, tu tournes en rond. Si je connais la sortie, c'est parce que je connais le subterfuge."
...
Il est possible de rester se baigner dans l'eau de l'Oasis, elle est tellement chaude et augmente la Force du Héros. (illusion, ça ne fait rien du tout).
Le Héros sera alors départagé entre deux options :

- Se baigner dans l'eau, et attendre que sa Force augmente avant d'aller affronter le Dragon derrière la porte.
- Aller affronter tout de suite le Dragon.

A chaque fois qu'il cliquera sur une action s'approchant de l'ouverture de la porte, des confirmations seront demandées, et des choix apparaîtront, comme : "Soit j'ouvre cette porte, soit je reste dans l'eau le temps de devenir plus fort".
Des pop-ups apparaîtront, et de multiples confirmations seront demandées, jusqu'à une ultime confirmation avec `window.alert` : "Êtes-vous sûr d'ouvrir cette porte ? (Si votre personnage meurt, vous perdrez toute votre progression et devrez redémarrer à zéro.)"
Lorsque le Joueur arrivera à cette ultime confirmation, la Force toute entière du Héros redescendra à son niveau initial, et il sera de nouveau demandé s'il veut ouvrir la porte.
Une autre voie lui sera d'ailleurs proposée, un portail apparaîtra entre deux, derrière celui-ci, une belle chambre lumineuse avec un matelas luxueux.

- **Si le Joueur décide d'aller dans la chambre**, la Sorcière apparaîtra, et se moquera de lui, pointant du doigt son manque de courage, et déclarant que derrière cette porte, ce n'était qu'elle, et qu'il n'est clairement pas prêt à affronter Zrog.
  Le joueur n'aura donc aucune récompense et pourra continuer l'aventure.
...
Le combat final se déroulera au sommet du Paradis. Il sera un combat de **survie**.
